# Tazkyah - Educational Platform

**Tazkyah** is a bilingual (Arabic & English) online platform dedicated to the Tazkyah initiative. Our mission is to nurture a generation of responsible and principled youth by offering high-quality, interactive courses that instill essential moral values in children.

## Table of Contents
- [Tazkyah - Educational Platform](#tazkyah---educational-platform)
...
Tazkyah.org serves as a course hosting and information platform where:
...
- **Admins** can update initiative details and manage users and content.
...
This project was developed by Team 12 for Course SWE 363 at KFUPM University. Our team members are as follows:
...
We collaborated to build this project.
