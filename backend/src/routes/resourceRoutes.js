...
router.post('/', requireRoles(['instructor', 'admin']), resourceController.uploadResource);

// Get all resources for a course
router.get('/course/:courseId', resourceController.getCourseResources);

// Get resources by type for a course
router.get('/course/:courseId/type/:type', resourceController.getResourcesByType);
...
router.put('/:id', requireRoles(['instructor', 'admin']), resourceController.updateResource);

// Delete a resource (Instructors, Admins only)
router.delete('/:id', requireRoles(['instructor', 'admin']), resourceController.deleteResource);
