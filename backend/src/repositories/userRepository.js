...
class UserRepository {
    ...
    async updateUser(id, updateData) {
        try {
            ...
            if (updateData.phoneNumber) personData.phoneNumber = updateData.phoneNumber;
            if (updateData.profilePicture) personData.profilePicture = updateData.profilePicture;
